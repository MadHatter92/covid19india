...
color = ['green' if end-beginning <= 0.0 else 'red' for end, beginning in zip(confirmed_2, confirmed_1)]

df = pd.DataFrame(({'State':state_list, 'Beginning': confirmed_1, 'End': confirmed_2, 'Color':color}))
...
plt.xlabel('Percentage confirmed out of total tested')
plt.title('COVID-19 Statewise Progress: Total confirmed cases out of total tested')
